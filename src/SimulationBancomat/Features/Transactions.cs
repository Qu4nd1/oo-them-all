...
namespace SimulationBancomat.Features
{
    static class Transactions
    {
        ...
        public static int customGetOutAmount = 0;
        public static int screenheigth = 16;
        public static decimal bankMoneyAmount = 1000;
        public static decimal[] withdrawalMoneyLogs = new decimal[100];
        ...
        static public void GetOutMoneyAmount(ref decimal bankMoneyAmount, ref decimal[] withdrawalMoneyLogs, ref int moneyWithdrawalIndex)
        {
