...
public class Teenager : Account
{
    public Teenager(string ownerType, string ownerName, int moneyAmount, string pwd) 
    ...
    {
        if (value > 0 && value < bankMoneyAmount && value < Factory.MaxTeenagerWithdrawal)
