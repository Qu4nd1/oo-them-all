...
namespace SimulationBancomat.Display
{
    class SuperConsole
    {
        ...
        public int SCREEN_X = PasswordData.PASSWORD_SCREEN_X - 5;
        public int SCREEN_Y = PasswordData.PASSWORD_SCREEN_Y - 1;
        public const int HORIZONTAL_SPACE = 7;
        public const int VERTICAL_SPACE = 4;
        public string[] emptyButton = new string[]
            {
                "┌───┐",
                "│   │",
                "└───┘"
        ...
        public void DrawNumPad(string[] emptyButton, char keyChar)
        {
        ...
        public void DrawAtString(int x, int y, string character)
        {
            Console.SetCursorPosition(x, y);
            Console.Write(character);
        }
        public void DrawAtCenterString(int x, int y, int width, string character)
        {
            int centerX = x + (width / 2) - (character.Length / 2);
            Console.SetCursorPosition(centerX, y);
            Console.Write(character);
        }
        public void DrawAtChar(int x, int y, char character)
        {
            Console.SetCursorPosition(x, y);
            Console.Write(character);
        }
        ...
        public void DrawHorizontalLine(int startX, int y, int length, char character)
        {
        ...
        public void DrawVerticalLine(int x, int startY, int length, char character)
        {
        ...
        public void PasswordVisualSuppression()
        {
